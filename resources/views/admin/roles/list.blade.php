                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-info btn-sm" href="{{ route('admin.' . $module . '.edit', ['role' => $record]) }}">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#confirmModal" data-url="{{ route('admin.' . $module . '.destroy', ['role' => $record]) }}">
